...
def test_reduce_leafs():
    ...
    res = dotted_catalog_path._reduce_leafs(id_urls)
...
def test_pack_leafs_list_to_obj():
    ...
    path_entitie_list = dotted_catalog_path._reduce_leafs(id_urls)
...
def test_do_dotted_paths():
    ...
    comp_urls = dotted_catalog_path.do_dotted_paths(key_urls)
